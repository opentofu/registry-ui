  ...
  return (
    <SidebarBlock title="Versions">
      <span className="mt-6 flex animate-pulse items-center justify-between">
        <span className="h-em flex w-16 bg-gray-500/25" />
        <span className="h-em flex w-32 bg-gray-500/25" />
      </span>
      <span className="mt-5 flex animate-pulse items-center justify-between">
        <span className="h-em flex w-20 bg-gray-500/25" />
        <span className="h-em flex w-28 bg-gray-500/25" />
      </span>
      <span className="mt-5 flex animate-pulse items-center justify-between">
        <span className="h-em flex w-12 bg-gray-500/25" />
